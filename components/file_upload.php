<?php
function file_upload($pet_picture) {
    ...
    $fileName = $pet_picture["name"];
    $fileType = $pet_picture["type"];
    $fileTmpName = $pet_picture["tmp_name"];
    $fileError = $pet_picture["error"];
    $fileSize = $pet_picture["size"];
